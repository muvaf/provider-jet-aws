...
func (in *ClusterObservation) DeepCopyInto(out *ClusterObservation) {
	*out = *in
	...
	if in.CoreInstanceFleet != nil {
		...
		*out = make([]CoreInstanceFleetObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.CoreInstanceGroup != nil {
		...
		*out = make([]CoreInstanceGroupObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MasterInstanceFleet != nil {
		...
		*out = make([]MasterInstanceFleetObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.MasterInstanceGroup != nil {
		...
		*out = make([]MasterInstanceGroupObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
